$(document).ready(function() {
    ...
    n.isotope({ filter: "*", animationOptions: { duration: 750, easing: "linear", queue: !1 } }), $("nav.primary ul a").click(function() { var a = $(this).attr("data-filter"); return n.isotope({ filter: a, animationOptions: { duration: 750, easing: "linear", queue: !1 } }), !1 });
    ...
    }), $("#slider-range").slider({ range: !0, min: 0, max: 500, values: [75, 300], slide: function(a, e) { $(".minvalue").html("$" + e.values[0]), $(".maxvalue").html("$" + e.values[1]) } }), $("#amount").val("$" + $("#slider-range").slider("values", 0) + " - $" + $("#slider-range").slider("values", 1)), $(".up").on("click", function() {
        var a = $(this),
