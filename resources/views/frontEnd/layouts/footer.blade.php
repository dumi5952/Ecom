<footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © 2020 Food2Go.lk. All rights reserved.</p>
            <p class="pull-right">Designed by <span><a target="_blank" href="{{url('https://www.facebook.com/Dmindu.Sachinthana')}}">Dumindu S Hettiarachchi</a></span></p>
            </div>
        </div>
    </div>
</footer><!--/Footer-->
